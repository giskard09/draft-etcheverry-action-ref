...
// AgentAvow addition: z sorts between the decomposed key (leading U+0065) and
// the precomposed key (U+00E9), two keys that render identically.
const kp = byName['unicode-key-position'];
check('z sorts between the two look-alike é keys',
  String(kp.indexOf('́') < kp.indexOf('"z"') && kp.indexOf('"z"') < kp.indexOf('é')),
  'true');
